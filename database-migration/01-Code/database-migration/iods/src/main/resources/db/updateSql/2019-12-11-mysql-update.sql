...
--  Lock Database
UPDATE VC_CHANGE_LOG_LOCK SET `LOCKED` = 1, LOCKEDBY = 'wangxun183963 (192.168.53.113)', LOCKGRANTED = '2019-12-11 17:06:38.017' WHERE ID = 1 AND `LOCKED` = 0;
