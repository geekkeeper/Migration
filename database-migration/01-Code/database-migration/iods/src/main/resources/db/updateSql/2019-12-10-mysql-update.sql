...
--  Lock Database
UPDATE VC_CHANGE_LOG_LOCK SET `LOCKED` = 1, LOCKEDBY = 'wangxun183963 (192.168.53.113)', LOCKGRANTED = '2019-12-10 18:50:11.434' WHERE ID = 1 AND `LOCKED` = 0;
